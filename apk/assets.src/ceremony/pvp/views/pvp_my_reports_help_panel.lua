PvpMyReportsHelpPanel = PvpView:new{
	jsonFile = 'panel/pvp_my_reports_help_panel.json',
	panelName = 'pvp-my-reports-help-panel'
}

function PvpMyReportsHelpPanel:init()
